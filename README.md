...
- 중심 핵에서 기술·궁극기로 갈라지고 다시 세부 변형을 고르는 캐릭터별 12노드 성좌
...
저장 위치와 복구 방식은 [기본 기능 v9](Docs/BASICS_V9.md), 새 전장과 규칙 버전 10은 [전장·카드 UI 개편](Docs/BATTLEFIELD_V10.md), 유물·두 성장 축은 [전투와 성장 v12](Docs/COMBAT_GROWTH_V12.md), 플레이어 기준 전투는 [전투 흐름 v13](Docs/COMBAT_FLOW_V13.md), 최신 정보 UI와 성좌 트리는 [전투 정보·성좌 성장 v14](Docs/COMBAT_READABILITY_V14.md)에 정리했습니다.

## 개발과 검증

구조는 `Runtime/Presentation → Application → Core`입니다. Unity에서 Test Runner의 EditMode 테스트를 실행할 수 있습니다. 최신 검증은 **150개 테스트 통과**, Full HD/720p 화면 fixture 32장, 게임 Runtime 오류 0건입니다. 카드 배치, 수치 키워드, 12노드 의존 분기와 실제 전투 변형을 함께 확인했습니다. 이는 Windows 빌드 수동 플레이, 전체 런 밸런스 검증이나 성능 측정 결과를 의미하지 않습니다.
