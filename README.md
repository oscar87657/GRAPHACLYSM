...
- 중앙 관문 양쪽의 새 옆모습 캐릭터 선택 초상, 기본 눈 감음·호버 눈 뜸 연출
...
구조는 `Runtime/Presentation → Application → Core`입니다. Unity에서 Test Runner의 EditMode 테스트를 실행할 수 있습니다. 최신 검증은 **140개 테스트 통과**, Full HD/720p 화면 fixture 27장, Runtime 오류 0건입니다. 양쪽 눈 전환과 지형 규칙, 기존 저장·전투 회귀를 함께 확인했습니다. 이는 Windows 빌드 수동 플레이, 전체 런 밸런스 검증이나 성능 측정 결과를 의미하지 않습니다.
