...
namespace Graphaclysm.Runtime.Presentation
{
    ...
    internal sealed class AstralUi
    {
        ...
        public readonly GUIStyle Logo, Display, PageTitle, PageTitleLight, Heading, HeadingLight, Body, Small, Number, Light, SmallLight, Formula;
        ...
        public AstralUi(System.Action onClick = null)
        {
            ...
            PageTitleLight = Style(orbit, 40, Paper);
